...
이음은 통화 내용(녹음 파일도 가능)과 카톡 대화만 입력하면, 함께 정리하고 응대 가이드라인까지 만들어드려요.
바쁜 상담이 끝나고 처음 보는 환자분이 오셔도, 이미 정리된 정보로 베테랑처럼 응대하실 수 있어요.
...
어떤 실장님이 받아도, 환자분은 응대받을 때 "이 병원이 나를 신경써주고 있네" 느끼실 수 있어요.`,
      ...
      },
      {
        ...
        heading: "환자분과 마주보는 시간,\n차트는 자동으로 정리돼요",
        body: `갑작스러운 현장 방문에도 대응할 수 있도록,
간단한 설문만으로 가이드라인과 스크립트가 작성돼요.
...
환자분과 마주보고 진정성 있는 대화를 나누실 수 있도록 도와드려요.`,
      ...
      },
      {
        ...
        heading:
          "원장님이 들어가시기 전에,\n환자분의 모든 이야기가 한 화면에",
        body: `전화부터 내원까지의 모든 대화·기록·걱정·예산을 한 화면에서 확인하실 수 있어요.
원장님은 환자분의 고민을 더 빠르게, 쉽게 파악하시고 맞춤 상담을 진행하실 수 있어요.
...
"막상 글로 쓰려니 어렵네" — 환자분의 그 마음이 후기 작성을 막아요.
환자분은 자신의 선택과 이야기가 담긴 초안을 보시고, 원하시는 대로 다듬으시기만 하면 돼요.
...
후기는 환자분 본인 계정으로 남기고, 병원에는 진정성 있는 후기들이 쌓여요.`,
  ...
  careNote: {
    ...
    description: `수술·시술이 끝난 뒤에도, 병원이 끝까지 환자분을 케어해드린다는 느낌을 드려요.
귀가 당일부터 환자분이 안심하실 때까지,
언제든 찾아오는 불안 섞인 연락에 실시간으로 응대할 수 있도록 도와드려요.
