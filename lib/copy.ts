...
export const COPY = {
  ...
  hero: {
    ...
    /** 세 번째 줄에 BRAND_BLUE 강조 적용 (인덱스 2). 마침표·느낌표 없이 끝. */
    h1HighlightLineIndex: 2,
    sub: "환자분이 다시 찾는 병원, 지인에게 소개해주는 병원으로.",
    ...
    cards: [
      {
        ...
        quote:
          "이제 막 우리 병원에 적응하고, 매출을 따오기 시작했는데 그만둬버렸어요. 새로 뽑아서 또 매출이 나오려면 한세월일텐데..",
      },
      {
        title: "광고보고 찾아와서 후기는 안써주시는 환자분들",
        quote:
          "광고 보고 오는 환자분들은 많은데, 후기를 써주시는 분들이 거의 없어요. 분명 퇴원하실 때는 만족한다고 하셨는데..",
      },
      {
        title: "수술 후 끊임없이 찾아오시고 연락하는 환자분",
        quote:
          "단순한 부작용인데도 너무 연락이 많이 와서 진료도 늦어지고 더 필요한 분들을 봐드릴 수가 없어요.",
      },
    ],
    ...
    stages: [
      {
        ...
        body: `실장님들, 상담 전화나 상담 내용을 받아 적기에도 빠듯하시죠? 새로 오신 실장님은 속도에 적응하느라 초반에는 환자분 정보를 제대로 파악 못한 채 응대하실 수밖에 없어요.

이음은 통화 내용(녹음 파일도 가능)과 카톡 대화만 입력하면, 함께 정리하고 응대 가이드라인까지 만들어드려요. 바쁜 상담이 끝나고 처음 보는 환자분이 오셔도, 이미 정리된 정보로 베테랑처럼 응대하실 수 있어요.

어떤 실장님이 받아도, 환자분은 응대받을 때 "이 병원이 나를 신경써주고 있네" 느끼실 수 있어요.`,
        checklist: [
      ...
      },
      {
        ...
        heading: "환자분과 마주보는 시간, 차트는 자동으로 정리돼요",
        body: `갑작스러운 현장 방문에도 대응할 수 있도록, 간단한 설문만으로 가이드라인과 스크립트가 작성돼요. 설문이 끝난 환자분이 의자에 앉기 전에, 이미 정리된 그분의 고민으로 현장 상담이 이어져요.

"잠깐 이야기했을 뿐인데 나를 이해하고 공감해주네." — 처음 방문한 환자분에게 이 느낌이 가장 중요해요.

실장님이 차트에 정리만 하는 게 아니라, 환자분과 마주보고 진정성 있는 대화를 나누실 수 있도록 도와드려요.`,
        checklist: [
          { text: "1차 상담 내용 자동 인계" },
          { text: "현장 상담 실시간 녹화" },
      ...
      },
      {
        ...
        body: `전화부터 내원까지의 모든 대화·기록·걱정·예산을 한 화면에서 확인하실 수 있어요. 원장님은 환자분의 고민을 더 빠르게, 쉽게 파악하시고 맞춤 상담을 진행하실 수 있어요.

환자분이 가장 안심하시는 순간은, "원장님이 나를 알고 공감해주고 계시는구나" 싶을 때예요.`,
        checklist: [
...
"막상 글로 쓰려니 어렵네" — 환자분의 그 마음이 후기 작성을 막아요. 환자분은 자신의 선택과 이야기가 담긴 초안을 보시고, 원하시는 대로 다듬으시기만 하면 돼요.

후기는 환자분 본인 계정으로 남기고, 병원에는 진정성 있는 후기들이 쌓여요.`,
    bullets: [
  ...
  careNote: {
    ...
    description: `수술·시술이 끝난 뒤에도, 병원이 끝까지 환자분을 케어해드린다는 느낌을 드려요. 귀가 당일부터 환자분이 안심하실 때까지, 언제든 찾아오는 불안 섞인 연락에 실시간으로 응대할 수 있도록 도와드려요.
...
매뉴얼대로가 아니라, 환자분 한 분 한 분의 상황에 맞춰서요.`,
  ...
  audience: {
    ...
    /** 꼬리 카피 — [pre + highlight(BRAND_BLUE-bold) + post] 한 줄로 표시 (Audience.tsx에서 <br /> 제거됨) */
    footer: {
      pre: "누구를 뽑아도, 누가 그만둬도, ",
      highlight: "병원의 상담 품질",
