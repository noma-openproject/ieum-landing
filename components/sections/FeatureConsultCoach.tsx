...
const CONSULT_STAGES: ConsultStage[] = [
  {
    ...
    body: 'AI가 전화와 카톡을 듣고 정리해요. 실장님은 환자분 이름만 누르면 바로 상담을 시작할 수 있어요. 누가 받아도, 환자분은 처음부터 "이 병원은 나를 알고 있네" 느낄 수 있어요.',
    checklist: [
  ...
  },
  {
    ...
    body: `전화 상담에서 나눈 모든 이야기가 현장 상담으로 이어져요. 환자분이 무엇을 걱정했고, 무엇을 듣고 싶어하셨는지 — 다시 묻지 않아도 돼요.
