...
const FAQ_DATA: FaqCategory[] = [
  {
    ...
    items: [
      ...
      {
        q: "기존 데이터를 옮겨올 수 있나요?",
        a: "네, 옮겨오실 수 있어요.\nCSV·엑셀 파일을 그대로 올리시면 일괄 등록돼요.\n기존 CRM에서 내보낸 파일 형식 그대로 받습니다. 별도 변환 작업은 없으세요.",
      },
      {
    ...
    items: [
      {
        ...
        a: "의료법 27조 3항(환자유인행위 금지)을 지키도록 설계했어요.\n\nAI는 후기 초안만 만들어드리고,\n실장님이 한 번 검토하신 뒤,\n환자분이 본인 계정으로 직접 게시하는 구조예요.\n대가성 금품도 일체 없습니다.",
      },
    ],
  },
  {
