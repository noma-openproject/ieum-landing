...
export default function FeatureReviewBuilder() {
  return (
    <FeatureBlock
      ...
      title={["상담에서 나눈 이야기가,", "환자분의 첫 후기가 돼요"]}
      description={`상담에서 나눈 이야기가 그대로 담긴 후기 초안이, 환자분 손에 먼저 도착해요. 환자분은 읽어보고 고치기만 하면 돼요.

"좋았는데 막상 글로 쓰려니 어렵네" — 그 마음을 환자분 본인의 말투 그대로 풀어드려요.`}
      bullets={[
